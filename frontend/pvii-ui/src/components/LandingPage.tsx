      ...
      <section className="flex flex-col items-center pt-40 md:pt-48 lg:py-24 min-h-screen scroll-mt-[100px]" id="home">
        <div className="flex flex-col lg:w-[1000px] md:w-[700px] md:gap-2">
          <FadeInVert duration={1.15}>
            <h1 className="font-cursive text-3xl md:text-5xl md:pl-4 lg:text-7xl pl-6"> give your clothes a</h1>
          </FadeInVert>
          ...
          <FadeInVert duration={1.35}>
            <p className="font-sansserif mx-auto pl-4 text-xl pt-6 md:pt-1 lg:pl-10 w-[280px] lg:w-[610px] lg:text-2xl md:w-[510px] md:pl-16 md:text-xl">
        ...
        <FadeInVert duration={1.5} delay={0.5} offset={-50}>
          <div className="hidden lg:flex flex-row pt-12 pl-96">
            ...
            <Button variant={"none"} className="bg-transparent font-cursive lg:pl-10 lg:ml-14 lg:pt-14 text-3xl hover:text-fresh">
              <a
                href="#choose"
                onClick={(e) => {
                  e.preventDefault();
