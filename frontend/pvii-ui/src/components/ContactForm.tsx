...
export function ContactForm() {
  ...
  return (
    <section className="flex flex-col items-center pt-10 pb-24" id="contact">
      <div className="flex flex-row justify-between w-[800px] border-4 p-10 bg-gradient-to-br from-card to-lighBack rounded-3xl border-button">
        <div className="pr-10">
          <h1 className="text-4xl pt-2 pb-8">Need Help?</h1>
          <p>We'd love to hear from you! Whether you have any questions about our services, want to inquire about our pickup and delivery service, or any other questions we're here to help. Fill out the form or reach out to us via email or phone. </p>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            />
            <Button size="sm" className="my-10" type="submit">Submit</Button>
          </form>
        </Form>
      </div>
    </section>
