...
function ServiceCarousel() {
  ...
  return (
    <section id="services" className="scroll-mt-[200px] pb-36">
      <h1 className="flex justify-center text-6xl pb-20">Services</h1>
          ...
          <CarouselContent className="-ml-1">
            {cards.map((card, index) => (
              <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                <div className="p-1">
                  <Card className="w-[300px] h-[300px] bg-gradient-to-br to-lighBack from-background" >
